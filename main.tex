...
\fancyfoot[R]{\textlt\small\color{faimsblue}\thepage}
\fancyfoot[L]{\textlt\small\color{faimsblue}\textbf{CC-BY} Macquarie University}
...
\textcolor{faimsblue}{
For} & Technical Advisory Group \& Steering Committee \\
\textcolor{faimsblue}{License} & Creative Commons 4.0 International - With Attribution \\
\textcolor{faimsblue}{Contact} & Brian Ballsun-Stanton <brian@faims.edu.au>
\\
...
\backgroundsetup{scale = 1, angle = 0, opacity = 1, position={145mm,0mm},
   contents = {\includegraphics[width = 60mm, keepaspectratio]
   {Faims-large.png}}}


% \backgroundsetup{scale = 1, angle = 0, opacity = 1, position={160mm,10mm},
%   contents = {\includegraphics[width = 40mm, keepaspectratio]
%   {Faims-large.png}}}
